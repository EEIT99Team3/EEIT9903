...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/css/ratio.css" />" />
	...
	<div>
		...
		<div class="card">
			...
			<div class="card-body" style="height: 700px">
				...
				<div class="item">
					<img id="arrow1" src="<c:url value="/images/icon7.png"/>" />
				</div>
				...
				<div class="item">
					<img id="arrow2" src="<c:url value="/images/icon7.png"/>" />
				</div>
				<div id="selected">
					<div class="title2">設定條件</div>
					<div id="ratyear" class="selectoryearseason">
						<span>年度</span> <select id="ratyeartv">
					...
					<div id="ratseason" class="selectoryearseason">
						<span>季別</span> <select id="ratseasontv">
							<option value="">請選擇</option>
					...
					<div id="bvpst" class="selectorc">
						<span>每股淨值</span> <select id="bvpstv">
							<option value="">請選擇</option>
